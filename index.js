const text = ["So, I wanted to do something that stood out. Maybe even sweep you off your feet a bit. So, I decided to do so in the best way I knew how - Building a website.",
        "This website has been made from scratch - from the design, to the words. It was done so to remain authenticity and portray genuine emotions. So, I hope you enjoy!",
        ...
        "which is something I would never take for granted.",
        ...
        "Very Beautiful! 😍", "Muy Hermosa! ", "Big up Mom and Dad! They did their thing.", "But anyways, long story short - I think you're amazing!", "Each day, I am filled with gratitude for the day we started talking.",
